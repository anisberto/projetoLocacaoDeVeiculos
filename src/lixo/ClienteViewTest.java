...
import br.com.pi.app.LoginView;
...
public class ClienteViewTest extends javax.swing.JFrame {

    EnderecoBllTeste endBll = new EnderecoBllTeste();
    EnderecoModel endereco = new EnderecoModel();
    //ICRUD_GENERIC novoEnderecoInter = null;
    //EnderecoInterface novoEnderecoInter = null;
    boolean incluirEndereco = true;
    int idDeleteCliente;

    public ClienteViewTest() throws Exception {
        initComponents();
...
//        consultarEndereco(novoEnderecoInter.getAll());
    ...
    private void initComponents() {
        ...
        tableEnderecoTest = new javax.swing.JTable();
        ...
        tableEnderecoTest.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableEnderecoTest.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableEnderecoTestMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tableEnderecoTest);
        if (tableEnderecoTest.getColumnModel().getColumnCount() > 0) {
            tableEnderecoTest.getColumnModel().getColumn(0).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(0).setPreferredWidth(25);
            tableEnderecoTest.getColumnModel().getColumn(1).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(2).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(3).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(4).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(5).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(6).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(7).setResizable(false);
            tableEnderecoTest.getColumnModel().getColumn(7).setPreferredWidth(20);
        }
...
//                    novoEnderecoInter.delete(idDeleteCliente);
                    limparEndereco();
     ...
     * @param evt
     */
    private void tableEnderecoTestMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEnderecoTestMouseClicked
        //int linha = tableEndereco.getSelectedRow();
        try {
            Integer codigo = Integer.parseInt(tableEnderecoTest.getValueAt(tableEnderecoTest.getSelectedRow(), 0).toString());
            ...
            Logger.getLogger(ClienteViewTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tableEnderecoTestMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteViewTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ClienteViewTest().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(ClienteViewTest.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTable tableEnderecoTest;
    ...
    private void consultarEndereco(Iterator lista) throws Exception {
        DefaultTableModel modelo = (DefaultTableModel) tableEnderecoTest.getModel();
        modelo.setNumRows(0);

       while (lista.hasNext()) {
            String[] linha = new String[8];
            EnderecoModel aux = (EnderecoModel) lista.next();
    ...
    private void transferirDadosEndereco() {
        try {
            int codigo = Integer.parseInt(tableEnderecoTest.getValueAt(tableEnderecoTest.getSelectedRow(), 0).toString());
//            EnderecoModel deleteEnd = (EnderecoModel) novoEnderecoInter.getById(codigo);
