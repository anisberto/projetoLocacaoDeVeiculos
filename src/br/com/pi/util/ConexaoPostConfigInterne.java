...
public class ConexaoPostConfigInterne implements ConnectionObservable {

    private static ConexaoPostConfigInterne conexao = null;
    private static Connection conect = null;
    List<ConnectionObserver> connectionObservers = new ArrayList<>();
    private boolean isConnected = true;

    private ConexaoPostConfigInterne() {
    }

    public static ConexaoPostConfigInterne getInstance() {
        if (conexao == null) {
            conexao = new ConexaoPostConfigInterne();
        }
        return conexao;
    }
    ...
    public Connection getConnectionConfigDateIntern() throws Exception {
        try {
        ...
        if (conect != null) {
            try {
                ...
                try {
                    ...
                    Logger.getLogger(ConexaoPostConfigInterne.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
